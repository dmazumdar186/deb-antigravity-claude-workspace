...
Or simply type `claude` directly — the workspace default is claude-fable-5-1 client mode (orchestrator model per the 2026-09-01 token-economy doctrine: Fable thinks, Sonnet sub-agents do the grunt work).
