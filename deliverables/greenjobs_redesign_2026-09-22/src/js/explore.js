'use strict';
/* Sector explorer (treemap that filters the list) and the salary explorer
   (histogram, median by sector, disclosure, jobs by region) — all from the
   embedded dataset, all with tooltips, keyboard focus and a table fallback. */
(function () {
  ...
  if (ins) {
    ...
    /* ---- one chart at a time: segmented control, #chart=… deep link */
