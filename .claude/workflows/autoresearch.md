...
- Default mutator model: `claude-fable-5` (copy + creative + prompt mutation).
- Default deployer/plumbing model: `claude-fable-5` (Haiku 4.5 is banned per ~/.claude/rules/model-tier.md; Sonnet is the minimum tier for any project work).
