...
>
> This skill touches `INSTANTLY_API_KEY`. Accessory Masters has been handed off and those
...
- Model: Uses `claude-fable-5-1` for generation (execution tier; full name pinned per ~/.claude/rules/model-tier.md)
