...
Run this skill on the execution tier (`/model claude-fable-5` before invoking). The task is procedural (classify → execute DOM action) and doesn't need the judgement tier.
