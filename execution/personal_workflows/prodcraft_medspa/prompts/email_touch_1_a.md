...
links_allowed: 1
---
subject: quick question about {{business_name}}'s booking

Hi {{owner_first}},

I was looking at {{business_name}} ({{fiveWordPlainDescriptionOfTheirBusiness}}) and noticed {{oneSentenceSpecificBookingGapObservedOnTheirSite}}. Most people won't call after hours, and most med spa bookings still start with a phone call.
