...
links_allowed: 1
---
subject: noticed something on {{business_name}}'s site
...
Totally fine to ignore. If you like the direction, I can build it out fully with your branding and booking system, and the balance is only due once it's live.
