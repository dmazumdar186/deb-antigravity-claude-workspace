"""
description: Typed contracts (Pydantic v2) shared by every layer of job_digest.
...
class RankedJob(BaseModel):
    ...
    ranker_model: str = Field(..., description="e.g. 'claude-fable-5-1' or 'gemini-2.5-flash'.")
