...
_BUCKET_BRIEFS = {
    "A": (
        ...
        "Mix half Track A (AI / Senior Product Manager CDI in FR/BE/DE/PL/AT/LU "
        "or remote-EU at AI-native or AI-heavy companies, mentioning "
        "RAG/LLM/multi-agent/eval/GDPR/PRD/GTM, Senior or above) and half "
        "Track B (Senior Product Owner / AI Product Owner CDI, agile delivery, "
        "backlog ownership, data/AI products). Title MUST appear (or be a "
        "near-literal variant) in profile.tracks[X].targeted_titles. Location "
        "MUST be in profile.locations.preferred or ok_remote. Contract MUST "
        "match the track's contract_types. Description (200-500 chars) MUST "
        "namedrop at least 5 profile skills (use the exact skill names from "
        "profile.skills) and at least one proof-point-adjacent metric "
        "(e.g. '+40% adoption', '<30 day ship cycle')."
    ),
    "B": (
        ...
        "(2) Product Owner at a traditional bank/insurer in Brussels or "
        "Vienna, CDI, no AI/data mention; (3) Mid-level Product Manager in "
        "Warsaw, English JD, no seniority signal; "
        "(4) Remote-EU Senior PM at AI scale-up but country is Spain/Italy "
        "(language risk); (5) Digital Product Owner at a non-tech firm "
    ...
    "SKIP": (
        ...
        "Engineer (Java/Spring) with NO AI mention Paris CDI; (9) Full Stack "
        "AI Engineer / ML Engineer Paris CDI (engineering role — out of the "
        "PM/PO-only scope); (10) Pure data "
