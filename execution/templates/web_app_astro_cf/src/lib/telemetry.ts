...
export const MODEL_PRICING_USD: Record<string, ModelPricingUSD> = {
  'claude-fable-5':       { input: 10.00, cache_read: 1.00, cache_write: 12.50, output: 50.00 }, // verified 2026-08-27; superseded 2026-09-01, kept for historical cost lookups  // retired 2026-09-21
