...
PRICING = {
    # claude-fable-5-1 MUST precede claude-fable-5 (retired 2026-09-21): price_for() does a
    ...
    "claude-fable-5":  {"input": 10.0, "cache_read": 1.0,  "cache_write": 12.5,  "output": 50.0},  # retired 2026-09-21
