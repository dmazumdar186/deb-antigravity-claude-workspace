# claude-client.ps1 -- CLIENT MODE: Claude Code with Fable 5.1 via Anthropic native.
...
Write-Host ""
Write-Host "CLIENT MODE -- Claude Code -> Anthropic native -> claude-fable-5-1" -ForegroundColor Green
Write-Host "PII / CV / leads / client data: OK. Billable." -ForegroundColor DarkGray
Write-Host ""

claude --model "claude-fable-5-1" @args
