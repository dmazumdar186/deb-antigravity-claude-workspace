...
Modes:
    cheap     — claude-fable-5-1 (Haiku is banned).
...
def main():
    ...
    parser.add_argument(
        ...
        help="Tier: cheap / balanced (claude-fable-5-1, default) / premium (claude-fable-5-1).",
    )
    parser.add_argument(
        "--model",
        default=None,
        help="Override model ID explicitly (bypasses --mode). "
             "Use OpenRouter format (e.g. anthropic/claude-fable-5.1).",
    )
