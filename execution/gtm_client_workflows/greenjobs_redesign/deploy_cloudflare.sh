#!/usr/bin/env bash
# Deploy the rendered GreenJobs redesign to Cloudflare Pages (free tier).
# Usage: bash execution/gtm_client_workflows/greenjobs_redesign/deploy_cloudflare.sh [site_dir] [project_name]
